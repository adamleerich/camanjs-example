...
(function($) {
    $.imageCrop = function(object, converted, customOptions) {
        ...
        // *BIND* a preview holder
        var $previewHolder = $("div#preview-holder");
        ...
        //             position : 'relative'
        //         })
        //         .attr('src', $converted.attr('src'))
        //         .appendTo($previewHolder);

        // *BIND* to a CANVAS and append it to the preview holder
        var $preview = $('<canvas id="image-crop-preview" />')
                .css({
                    position : 'relative'
                })
                .attr('src', $converted.attr('src'))
        ...
        kman = Caman($preview.get(0), $image.attr('src'), function() {
